...
class HelpExplanationActivity : AppCompatActivity() {
    ...
    private fun getText1(){
     ...
     "באפליקציה הזו" +"\n"+
                ...
                "אין כאן שום סדר לוגי אין התפתחות בעלילה הקיצר יש מה שיש." +"\n"+
                "האפליקציה יושבת על הענן כך שכל מה שאני מפרסם מופיע מידבזמן אמיתי אצלכם." +"\n"+
                ...
                " אני מניח שכל כמה שבועות יצא עדכון אז אל תתיאשו." +"\n"+
                        ""
    ...
    private fun getText2(){
        val st= "אז איך מתחילים," +"\n"+
                ...
                "האומנות להחליק בעדינות כך שרק פוסט יעבור(טיפ:תן וקטור חזק יותר ורטיקלי ועדין יותר לצד)" +"\n"+
                "בכל מקרה" +"\n"+
                "זה יכול להיות משחק יפה להחליק כמה תמונות במכה למי שאוהב משחקי החלקה." +"\n"+
                "במידה ותקליק על התמונה תגיע למסך ההערות," +"\n"+
    ...
    private fun getText21(){
        ...
        "------------------------" +"\n"+
                ...
                "מי הממליץ ? אני." +"\n"+
                "למה ואיך ? סתם ." +"\n"+
                "זה פחות או יותר רשימה עקרונית שתעודכן לפי הרצונות של המשתמשים" +"\n"+
        "------------------------" +"\n"+
